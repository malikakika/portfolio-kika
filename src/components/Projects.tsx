...
export default function Projects() {
    ...
    <section className="pj-section" id="projects">
      <div className="pj-container">
        ...
        >
          ...
          <p className="pj-sub">
            {t("projects.subtitle", "Une sélection de réalisations récentes.")}
          </p>
        </motion.div>
          ...
          {visible.map((p) => (
            ...
            >
              <div className="pj-cover">
                ...
                <span className={`pj-cat cat-${p.category}`}>
                  ...
                  {p.live && (
                    ...
                    >
                      ...
                      >
                        <path
                          fill="currentColor"
                          d="M14 3h7v7h-2V6.41l-9.29 9.3-1.42-1.42 9.3-9.29H14V3zM5 5h5V3H3v7h2V5zm0 14h5v2H3v-7h2v5zm14 0v-5h2v7h-7v-2h5z"
                        />
                      </svg>
                    </a>
                  )}
  ...
  viewport={{ once: true, amount: 0.2 }}
>
  <motion.li className="pj-card pj-more" variants={itemV} whileHover={{ y: -3 }}>
    <div className="pj-body">
      <h3 className="pj-title">
        {t("projects.githubCard.title", "My GitHub Projects")}
      </h3>
      <p className="pj-brief">
        {t(
          "projects.githubCard.desc",
          "Explore all my work, contributions and experiments directly on my GitHub profile."
        )}
      </p>
      <div className="pj-actions">
        <a
          href={t(
            "projects.githubCard.url",
            "https://github.com/malikachoubri"
          )}
          target="_blank"
          rel="noreferrer"
          className="btn small primary"
        >
          {t("projects.githubCard.cta", "Open my GitHub")}
        </a>
      </div>
    </div>
  </motion.li>
